...
summary: "Esta página foi elaborada para apoiar usuários que estão utilizando a ferramenta pela primeira vez...."
---
...
![Tela de Revisão de Consentimento](./anexos/imagens/detentorContasTransmissaoDeDados/tela1RevisaoConsent.png)
...
![Tela Confirmação de Consentimento](./anexos/imagens/detentorContasTransmissaoDeDados/tela2ConfirmConsent.png)
...
![Tela de Handoff](./anexos/imagens/detentorContasTransmissaoDeDados/tela3Handoff.png)
...
![Implementação em Kotlin](./anexos/imagens/detentorContasTransmissaoDeDados/implementacaoKotlin.png)
