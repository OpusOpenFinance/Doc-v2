---
title: "Investimentos"
summary: "Todas as modalidades de investimento são passíveis de compartilhamento de dados no escopo do Open Finance Brasil."
---
...
| API                        | Link                                      |
| -------------------------- |:-----------------------------------------:|
| Renda fixa bancária        | [Neste link](./rendaFixaBancaria)    |
| Renda fixa crédito         | [Neste link](./rendaFixaCredito)     |
| Renda variável             | [Neste link](./rendaVariavel)        |
| Títulos do tesouro direto  | [Neste link](./titulosTesouroDireto) |
| Fundos de investimento     | [Neste link](./fundosInvestimento)   |
