...
summary: "Para se tornar uma instituição apta a realizar Iniciações de Transação de Pagamento (ITP), é necessário cumprir uma série de pré-requisitos e requisitos orga..."
---
...
1. [**Certificação OpenID RP**](../../certificacoesECertificados):
...
3. **Certificação e publicação de APIs Payment** (se a instituição também for Detentora de Conta):
    Para o caso de a instituição ser participantes do Open Finance como Detentora de Conta também, é necessário estar de acordo com toda a regulação desse perfil antes mesmo de poder começar a homologação como ITP. O perfil de Detentora de Conta exige a publicação da [certificação OpenID OP](../../certificacoesECertificados) e que suas APIs estejam devidamente publicadas.
